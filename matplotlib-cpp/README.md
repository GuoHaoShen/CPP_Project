...
Install for Ubuntu
-----
Download the zip package on github and extract it or run git clone https://github.com/lava/matplotlib-cpp.git
...
After that, you can find file matplotlibcpp.h in the folder of /usr/local/include and We can refer to this header file directly in our code.
